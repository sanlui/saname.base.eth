      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="animate-fade-in" style={{animationDelay: '0.4s'}}>
            ...
            <FeatureCard
              ...
              children="From idea to live token in seconds. Our streamlined process leverages the speed of Base for near-instant deployment."
            />
        </div>
        <div className="animate-fade-in" style={{animationDelay: '0.5s'}}>
            ...
            <FeatureCard
              ...
              children="You have 100% control of your token. We don't hold your keys or contracts. Your creation, your rules."
            />
        </div>
        <div className="animate-fade-in" style={{animationDelay: '0.6s'}}>
            ...
            <FeatureCard
              ...
              children="Leveraging Base for minimal gas fees. A single, transparent deployment fee. No hidden costs or surprises."
            />
        </div>
      </div>
    </section>
